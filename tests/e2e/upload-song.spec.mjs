// E2E test: Upload a song (a_horse.mp3) after dismissing dialogs
...
let MP3_PATH = new URL("./test-files/a_horse.mp3", import.meta.url).pathname;
...
true  C:\Users\simon\Dropbox\prog\Troff collection\pwa_troff\tests\e2e
      C:\Users\simon\Dropbox\prog\Troff collection\pwa_troff\tests\e2e\test-files\a_horse.mp3

 * 
 * This test loads the app, dismisses dialogs, uploads a song, and takes screenshots along the way.
 */
test.describe("Upload song", () => {
  test("should load app, handle dialogs, upload a_horse.mp3, screenshot", async ({
    page,
  }) => {
    ...
    await assertSongLoadedUI(page, "a_horse");
    await page.screenshot({
