...
export const TROFF_SETTING_KEEP_SCREEN_ON: string = 'TROFF_SETTING_KEEP_SCREEN_ON';
export const TROFF_SETTING_DARK_MODE: string = 'TROFF_SETTING_DARK_MODE';
export const TROFF_SETTING_PREFER_VERSION: string = 'TROFF_SETTING_PREFER_VERSION';
export const TROFF_SETTING_BANNER_SHOW: string = 'TROFF_SETTING_BANNER_SHOW';
export const TROFF_SETTING_PORTRAIT: string = 'TROFF_SETTING_PORTRAIT';
// Legacy constants kept for backward compatibility (scriptTroffClass.ts)
...
// Legacy play button behaviour constants kept for backward compatibility (scriptTroffClass.ts)
...
// Global default song value keys (saved in nDB for new/per-song fallback)
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_START_BEFORE_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_START_BEFORE_VALUE';
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_STOP_AFTER_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_STOP_AFTER_VALUE';
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_PAUSE_BEFORE_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_PAUSE_BEFORE_VALUE';
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_WAIT_BETWEEN_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_WAIT_BETWEEN_VALUE';
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_SPEED_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_SPEED_VALUE';
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_VOLUME_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_VOLUME_VALUE';
export const TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_NR_LOOPS_VALUE: string =
  'TROFF_SAVE_VALUE_TROFF_SETTING_SONG_DEFAULT_NR_LOOPS_VALUE';

// Global default song on/off keys
export const TROFF_SETTING_SONG_DEFAULT_START_BEFORE_ON: string =
  'TROFF_SETTING_SONG_DEFAULT_START_BEFORE_ON';
export const TROFF_SETTING_SONG_DEFAULT_STOP_AFTER_ON: string =
  'TROFF_SETTING_SONG_DEFAULT_STOP_AFTER_ON';
export const TROFF_SETTING_SONG_DEFAULT_PAUSE_BEFORE_ON: string =
  'TROFF_SETTING_SONG_DEFAULT_PAUSE_BEFORE_ON';
export const TROFF_SETTING_SONG_DEFAULT_WAIT_BETWEEN_ON: string =
  'TROFF_SETTING_SONG_DEFAULT_WAIT_BETWEEN_ON';
export const TROFF_SETTING_SONG_DEFAULT_INCREMENT_UNTIL_ON: string =
  'TROFF_SETTING_SONG_DEFAULT_INCREMENT_UNTIL_ON';
export const TROFF_SETTING_SONG_DEFAULT_NR_LOOPS_INFINIT_IS_ON: string =
